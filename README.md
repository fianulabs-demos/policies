...
fianu console deploy "simple/*" --project fianulabs-demos --repository entities-as-code --commits-only="false" --dry-run="false" --commit aff2131cbdf6e4b5abb4bf78cf08ec4f2ca483eb
